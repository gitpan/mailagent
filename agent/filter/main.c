...
/*
 * $Id: main.c,v 3.0.1.2 1995/08/31 16:19:51 ram Exp $
 *
...
char **envp;
{
	...
	read_conf(".mailagent");			/* Read configuration file */

	add_log(19, "starting processing");
